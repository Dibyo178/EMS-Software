...
const formatCurrency = (amount) =>
    amount == null ? 'BDT 0.00' : `BDT ${parseFloat(amount).toFixed(2)}`;
</script>
      ...
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="flex justify-between items-center mb-8 px-4 sm:px-0">
          ...
          <Link :href="route('class-fee-structures.create')">
            <button
              class="inline-flex items-center space-x-2 px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150"
            >
        ...
        <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          <div v-for="structure in classFeeStructures.data" :key="structure.id" class="bg-white rounded-lg shadow-md transition-all hover:shadow-lg">
            ...
            <div class="p-6 text-sm text-gray-600">
              ...
              <div class="flex items-center mb-1">
                <svg
                  ...
                  stroke-width="2"
                >
                  <path stroke-linecap="round" stroke-linejoin="round" d="M8 7V3m8 4V3m-9 8h.01M16 11h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              ...
              <div class="flex items-center mb-1">
                <svg
                  ...
                  stroke-width="2"
                >
                  <path stroke-linecap="round" stroke-linejoin="round" d="M17 20h2a2 2 0 00-5.356-1.857M17 20H2v-2a3 3 0 015.356-1.857M17 20v-2c0-.523-.13-1.03-.356-1.571m0 0A5.002 5.002 0 0110 14.5a5.002 5.002 0 01-6.644 1.643M2 20h20" />
                </svg>
              ...
              <div class="flex items-center">
                <svg
                  ...
                  stroke-width="2"
                >
                  <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.253v13m0-13C10.832 5.485 9.166 5 7.5 5S4.167 5.485 3 6.253v13C4.167 18.485 5.833 18 7.5 18s3.333.485 4.5 1.253m0-13C13.168 5.485 14.834 5 16.5 5s3.333.485 4.5 1.253v13C19.833 18.485 18.167 18 16.5 18s-3.333.485-4.5 1.253" />
                </svg>
            ...
            <div class="p-6 border-t border-gray-200 flex justify-end space-x-3">
              <Link :href="route('class-fee-structures.edit', structure.id)">
                <button
                  class="p-2 border border-gray-300 rounded-md text-gray-500 hover:text-indigo-600 hover:bg-gray-100 transition-colors"
                >
              ...
              <button
                ...
                class="p-2 border border-gray-300 rounded-md text-gray-500 hover:text-red-600 hover:bg-gray-100 transition-colors"
              >
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                  <path d="M3 6h18" />
          ...
          <p v-if="!classFeeStructures.data.length" class="col-span-full text-center py-8 text-gray-500 text-lg">
            No class fee structures found.
          </p>
        </div>
